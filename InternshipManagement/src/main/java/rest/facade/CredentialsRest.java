...
import rest.service.implementations.CredentialsCrudService;

@Path("/credentials")
@ManagedEntity(Credentials.class)
public class CredentialsRest extends AbstractCrudApi<Credentials, CredentialsStoreResponse> {

  @EJB
  private CredentialsCrudService credentialsCrudService;

  @Override
  protected CrudService<Credentials, CredentialsStoreResponse> getServiceBean() {
    return credentialsCrudService;
  }
  ...
  public Response create(Credentials rec) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public Response update(Credentials rec, @PathParam("id") Long id) {
