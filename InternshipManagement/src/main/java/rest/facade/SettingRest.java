...
public class SettingRest extends AbstractCrudApi<Setting, SettingStoreResponse> {
  ...
  @Override
  protected CrudService<Setting, SettingStoreResponse> getServiceBean() {
    return settingCrudService;
  }
  ...
  public Response create(Setting rec) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public Response update(Setting rec, @PathParam("id") Long id) {
