...
@Path("/request")
@ManagedEntity(Request.class)
public class RequestRest extends AbstractCrudApi<Request, RequestStoreResponse> {

  @EJB
  private RequestCrudService requestCrudService;

  @Override
  protected CrudService<Request, RequestStoreResponse> getServiceBean() {
    return requestCrudService;
  }
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public Response update(Request rec, @PathParam("id") Long id) {
